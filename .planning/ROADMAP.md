...
- [ ] **Phase 6: Escrita EXIF de localização** - Localização inferida vira EXIF real no arquivo original, só em campo vazio, via plano dry-run aprovado
...
| 6. Escrita EXIF de localização | v2.0 | 0/TBD | Not started | - |
